...
import id.xxx.submission.data.model.the_movie_db.*
...
object DummyData {
    fun movieResultModel(): List<MovieResultModel> {
        return listOf(
            MovieResultModel(
                popularity = 2151.476,
                vote_count = 22,
    ...
    fun tvResultModel(): List<TvResultModel> {
        return listOf(
            TvResultModel(
    ...
    fun movieResponse(): MovieResponse {
        val list: List<MovieResultModel> = listOf(
            MovieResultModel(
                popularity = 2151.476,
                vote_count = 22,
                poster_path = "/6CoRTJTmijhBLJTUNoVSUNxZMEI.jpg",
    ...
    fun tvResponse(): TvResponse {
        val list: List<TvResultModel> = listOf(
            TvResultModel(
                original_name = "The Boys",
                genre_ids = listOf(10759, 10765),
                name = "The Boys",
    ...
    fun movieDetailModel(): MovieDetailModel {
    ...
    fun tvDetailModel(): TvDetailModel {
